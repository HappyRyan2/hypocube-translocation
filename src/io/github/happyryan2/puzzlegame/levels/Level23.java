...
public class Level23 extends Level {
	public Level23() {
		...
		// super.content.add(new Retractor(1, 1, "up", false));super.content.add(new Retractor(2, 3, "down", false));

		super.content.add(new Retractor(2, 4, "left", false));
		super.content.add(new Goal(1, 1));
		super.content.add(new Player(1, 4));
		super.content.add(new Wall(3, 5));
		super.content.add(new Wall(3, 6));
		super.content.add(new LongExtender(1, 5, "up", true));
